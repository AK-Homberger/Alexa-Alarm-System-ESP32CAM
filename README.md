...
- Extendable with external window/door [alarm sensors](https://github.com/AK-Homberger/Alexa-Alarm-System-ESP32CAM/blob/main/AlarmContact.md) library (Hue emulation) is used to switch On/Off motion detection via Alexa voice commands
